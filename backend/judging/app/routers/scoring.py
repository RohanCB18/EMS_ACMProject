...
Endpoints:
- POST /                    — Submit scores for a project
- GET  /project/{project_id} — Get all scores for a project
- GET  /judge/{judge_id}     — Get all evaluations by a judge
- GET  /{score_id}           — Get a single evaluation
"""
