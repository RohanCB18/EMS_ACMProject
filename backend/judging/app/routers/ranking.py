...
Endpoints:
- GET  /{event_id}            — Get aggregated rankings for an event
- POST /{event_id}/shortlist  — Shortlist projects for next round
- GET  /{event_id}/export     — Export winner list as JSON
"""
