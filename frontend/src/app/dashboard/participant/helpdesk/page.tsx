...
import { MessageCircle, AlertCircle, Clock, CheckCircle2, Plus, Loader2 } from "lucide-react";
...
export default function ParticipantHelpdeskPage() {
    ...
    const fetchTickets = async () => {
        try {
            ...
            // Filter to only show the current user's tickets
            const myTickets = user
                ? data.filter(t => t.raised_by_uid === user.uid)
                : data;
    ...
    const handleCreateTicket = async (e: React.FormEvent) => {
        ...
        try {
            await setDApi.createTicket({
                ...
                priority: "medium", // Auto-assigned, not user-selectable
                status: "open",
        ...
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-muted-foreground">Raise support tickets and track their resolution.</p>
                </div>
                <Dialog open={createOpen} onOpenChange={setCreateOpen}>
                    <DialogTrigger asChild>
                        <Button><Plus className="w-4 h-4 mr-2" />Raise a Ticket</Button>
                    </DialogTrigger>
                    <DialogContent className="sm:max-w-[480px]">
                        <DialogHeader>
                            <DialogTitle>Raise a Support Ticket</DialogTitle>
                            <DialogDescription>
                                Describe the issue you&apos;re facing. Our team will assign it and get back to you.
                            </DialogDescription>
                        </DialogHeader>
                        <form onSubmit={handleCreateTicket} className="space-y-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <Textarea
                                    ...
                                    placeholder="Provide a detailed description so we can resolve this faster..."
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                ...
                <Card className="border-blue-200 bg-blue-50/30 dark:bg-blue-900/10">
                    ...
                    <CardContent className="p-4 pt-0 text-center">
                        ...
                        <p className="text-xs text-muted-foreground uppercase">Being Worked On</p>
                    </CardContent>
                </Card>
                ...
                <Card>
                    ...
                    <CardContent className="p-4 pt-0 text-center">
                        ...
                        <p className="text-xs text-muted-foreground uppercase">My Tickets</p>
                    </CardContent>
                </Card>
            </div>
                            ...
                            {tickets.map((ticket) => (
                                <TableRow key={ticket.ticket_id}>
                                    ...
                                    <TableCell>
                                        ...
                                        <div className="text-xs text-muted-foreground">{ticket.description?.substring(0, 80)}{(ticket.description?.length || 0) > 80 ? '…' : ''}</div>
                                    </TableCell>
                                    <TableCell>
                            ...
                            {tickets.length === 0 && (
                                <TableRow>
                                    <TableCell colSpan={5} className="text-center py-12 text-muted-foreground">
                                        ...
                                        <p className="text-xs mt-1">Click &quot;Raise a Ticket&quot; if you need help.</p>
                                    </TableCell>
                                </TableRow>
                            )}
                        </TableBody>
